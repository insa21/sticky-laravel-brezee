                ...
                @auth
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown placement="bottom-end">
                            <x-slot name="trigger">
                                <button
                                    class="flex items-center text-sm font-medium text-white bg-zinc-800 border border-zinc-700 rounded-lg p-2  hover:text-white focus:outline-none transition duration-150 ease-in-out">
